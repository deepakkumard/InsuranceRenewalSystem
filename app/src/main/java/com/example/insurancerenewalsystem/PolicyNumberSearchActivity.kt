                ...
                if (days.equals("30")) {
                    ...
                    if (ActivityCompat.checkSelfPermission(
                        ...
                        smsManager.sendTextMessage(
                            ...
                            null,
                            "Greetings from ABC INSURANCE COMPANY. This message is to notify you that about the end of the renewel period of your policy.  Please ensure that you would renew it before the last date of " + InsurancenumberModelclass.DTT_EXPIRY_DATE + " and your ref policy number : " + InsurancenumberModelclass.VCH_POLICY_NO,
                            null,
                            null
                        )
                        Toast.makeText(
